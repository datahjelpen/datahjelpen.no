...
<div class="layout-square-large primary-bg depth-2">
	...
	<h1 class="font-huge center-align white-text">Personvern</h1>
	<section class="grey-bg grid grid-large content no-padding">
		<div class="row white-bg">
			<div class="col s12 l6">
				<div class="grid-content links">
					<div class="hide-on-large-only center-align space-v-medium">
						<img class="avatar-large circle grey-bg" src="/images/graphics/privacy/privacy-user.png" alt="Personvern">
					</div>
					<h3 class="font-medium">Personvern</h3>
					<p>
			...
			<div class="col s12 l6 right hide-on-large-and-down">
				<div class="bg-image" style="background-image: url('/images/graphics/privacy/privacy-user.png')"></div>
			</div>
		</div>
		<div id="line_sharina_hagen" class="row">
			...
			<div class="col s12 l6">
				<div class="grid-content">
					...
					<h3 class="font-medium">Line Sharina Hagen</h3>
					<h4>Daglig leder</h4>
					<p>
		...
		<div id="bjornar_hagen" class="row white-bg">
			<div class="col s12 l6">
				<div class="grid-content">
					...
					<h3 class="font-medium">Bjørnar Hagen</h3>
